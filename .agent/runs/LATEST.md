...
> Auto-generated from `.agent/runs/_summary.jsonl`. Read this whenever you open a new Claude / Antigravity / shell session in this repo to pick up where the last dispatch left off.
